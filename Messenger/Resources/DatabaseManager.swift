...
//  Messenger
//
//  Created by Kevin Terwelp on 4/18/21.
//
...
extension DatabaseManager {
    ...
    public enum DatabaseError: Error {
        ...
        public var localizedDescription: String {
            switch self {
            // Used often throughout this class
            // Good to be more specific about each error
            case .failedToFetch:
                return "This means blah failed for example"
            }
        }
    }
}
...
struct ChatAppUser {
    ...
    var profilePictureFileName: String {
        //kevin-terwelp-gmail-com_profile_picture.png
